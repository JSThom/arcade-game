# -*- coding: utf-8 -*-
"""
Created on Sat Oct 20 21:54:25 2018
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for x in range(0, SCREEN_WIDTH, SPRITE_SIZE * 5):
            wall = arcade.Sprite("images/box_crate.png", SPRITE_SCALING)
        ...
        enemy = arcade.Sprite("images/monster.png", SPRITE_SCALING)
        ...
        enemy.bottom = SPRITE_SIZE * 3
        enemy.left = SPRITE_SIZE * 9

        # Set boundaries on the left/right the enemy can't cross
        enemy.boundary_right = SPRITE_SIZE * 15
        enemy.boundary_left = SPRITE_SIZE * 3
        enemy.change_x = 2
        self.enemy_list.append(enemy)

        # -- Set up the player
        self.player_sprite = arcade.Sprite("images/hero.jpeg", SPRITE_SCALING)
